...
--
-- Хост: 127.0.0.1:3306
-- Час створення: Бер 15 2017 р., 22:13
...
CREATE TABLE IF NOT EXISTS `calendar` (
  ...
  `sklep` varchar(255) NOT NULL,
  `name_1` varchar(255) DEFAULT NULL,
  `sklep_1` varchar(255) DEFAULT NULL,
  `name_2` varchar(255) DEFAULT NULL,
  `sklep_2` varchar(255) DEFAULT NULL,
  `name_3` varchar(255) DEFAULT NULL,
  `sklep_3` varchar(255) DEFAULT NULL,
  `name_4` varchar(255) DEFAULT NULL,
  `sklep_4` varchar(255) DEFAULT NULL,
  `name_5` varchar(255) DEFAULT NULL,
  `sklep_5` varchar(255) DEFAULT NULL,
  `name_6` varchar(255) DEFAULT NULL,
  `sklep_6` varchar(255) DEFAULT NULL,
  `name_7` varchar(255) DEFAULT NULL,
  `sklep_7` varchar(255) DEFAULT NULL,
  `name_8` varchar(255) DEFAULT NULL,
  `sklep_8` varchar(255) DEFAULT NULL,
  `name_9` varchar(255) DEFAULT NULL,
  `sklep_9` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `cart` (
  ...
  `price_in_sum` float NOT NULL,
  `provider` varchar(255) NOT NULL,
  `manufacturer` varchar(255) NOT NULL,
  `photo` varchar(255) NOT NULL,
  `date` datetime NOT NULL,
  `user_name` varchar(255) NOT NULL,
  `price_out_sum` double NOT NULL,
...
--
-- Структура таблиці `coefficients`
--
...
CREATE TABLE IF NOT EXISTS `coefficients` (
  ...
  `vat` float NOT NULL,
  `manager_coef` float NOT NULL,
  `curator_coef` float NOT NULL,
  `admin_coef` float NOT NULL,
  `user_id` int(11) NOT NULL,
  `status` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Структура таблиці `data_worked`
--

CREATE TABLE IF NOT EXISTS `data_worked` (
  `id` int(11) NOT NULL,
  `date` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Структура таблиці `declarations`
--
...
CREATE TABLE IF NOT EXISTS `declarations` (
  ...
  `date` datetime NOT NULL,
  `declar_numb` varchar(20) NOT NULL,
  `places_numb` int(5) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `exchange_rates` (
  `id` int(11) NOT NULL,
  `zloty` float NOT NULL,
  `zloty_repair` float NOT NULL,
  `euro` float NOT NULL,
  `euro_repair` float NOT NULL,
  `us_dollar` double NOT NULL,
  `us_dollar_repair` double DEFAULT NULL,
...
INSERT INTO `exchange_rates` (`id`, `zloty`, `zloty_repair`, `euro`, `euro_repair`, `us_dollar`, `us_dollar_repair`, `auto`, `status`) VALUES
(1, 6.65, 1.45, 29.44, 0.02, 24.61, 0.002, 0, 0);
...
CREATE TABLE IF NOT EXISTS `news` (
  `news` varchar(50) DEFAULT NULL COMMENT 'Ќ®ў®бвЁ',
  `lang` varchar(10) DEFAULT NULL COMMENT 'Љ®¤ п§лЄ ',
  `data_od` varchar(10) DEFAULT NULL COMMENT 'Ќ з «м­ п ¤ в ',
  `data_do` varchar(10) DEFAULT NULL COMMENT 'Љ®­Ґз­ п ¤ в ',
  `temat` varchar(256) CHARACTER SET cp1250 DEFAULT NULL COMMENT '’Ґ¬ вЁЄ ',
  `news_folder` varchar(100) DEFAULT NULL COMMENT 'Џ ЇЄ , ў Є®в®а®© а §¬ҐйҐ­л д ©«л ­®ў®бвҐ©',
  `is_zip` int(11) DEFAULT NULL COMMENT 'ЏаЁ§­ Є  аеЁў  Ёбе®¤­ле ¤ ­­ле ­®ў®бвҐ©, Ї® Є®в®ал¬ Ї®«гзҐ­л д ©«л (0 - cws, 1 - zip)'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='’ Ў«Ёж  ­®ў®бвҐ©';

-- --------------------------------------------------------

--
-- Структура таблиці `numbers_add`
--

CREATE TABLE IF NOT EXISTS `numbers_add` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `results_add_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `user_name` text,
  `price_out_sum` double DEFAULT NULL,
  ...
  `date` date NOT NULL,
  `manufacturer` varchar(255) NOT NULL,
  `com_course` float NOT NULL,
  `vat` float NOT NULL,
  `logistic_pln` float NOT NULL,
  `logistic_grn` float NOT NULL,
  `com_grn` float NOT NULL,
  `logist_pln` float NOT NULL,
...
CREATE TABLE IF NOT EXISTS `results` (
  ...
  `result_photo` varchar(255) NOT NULL,
  `result_manufacturer` varchar(11) NOT NULL,
  `result_price` float NOT NULL,
  `result_info` varchar(255) NOT NULL,
  `def_price` float NOT NULL,
  `site` varchar(255) NOT NULL,
  `result_cod` varchar(255) NOT NULL,
  `result_state` varchar(255) NOT NULL,
...
--
-- Структура таблиці `results_add`
--

CREATE TABLE IF NOT EXISTS `results_add` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Структура таблиці `results_admin`
--

CREATE TABLE IF NOT EXISTS `results_admin` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `result_name` varchar(255) NOT NULL,
  `result_photo` varchar(255) NOT NULL,
  `result_manufacturer` varchar(255) NOT NULL,
  `result_price` float NOT NULL,
  `result_info` varchar(255) NOT NULL,
  `def_price` float NOT NULL,
  `site` varchar(255) NOT NULL,
...
--
-- Структура таблиці `sites_access_control`
--

CREATE TABLE IF NOT EXISTS `sites_access_control` (
  `id` int(11) NOT NULL,
...
--
-- Дамп даних таблиці `sites_access_control`
--

INSERT INTO `sites_access_control` (`id`, `site_url`, `site_name`, `login`, `password`, `status`) VALUES
(1, 'http://sklep.martextruck.pl/', 'Мартекс', 'H9213', '142536', 1),
(2, 'http://webcatalog.opoltrans.com.pl/', 'Опольтранс', 'LcParts', 'Lc142536789', 1),
(3, 'http://www.intercars.com.pl/', 'Інтеркарс', '839889', 'Lc754583', 0),
(4, 'http://sklep.skuba.com.pl', 'Скуба', 'LcParts', 'Lc754583', 0),
(5, 'http://www.diesel-czesci.pl/', 'Дізель', 'oreandrlviv@rambler.ru', 'leotrans123', 1);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `reg_like` varchar(100) NOT NULL,
  `default_note` text,
  `opole` int(1) DEFAULT '0',
  `martecs` int(1) DEFAULT '0',
  `ip` varchar(32) DEFAULT NULL,
  `district` varchar(255) DEFAULT NULL,
  `date` datetime DEFAULT NULL,
  `organisation_status` varchar(30) DEFAULT NULL,
  ...
  `show_codes` int(11) NOT NULL DEFAULT '0'
...
INSERT INTO `users` (`id`, `email`, `password`, `organisation`, `username`, `phone`, `city`, `hashcode`, `status`, `role`, `reg_like`, `default_note`, `opole`, `martecs`, `ip`, `district`, `date`, `organisation_status`, `country`, `region`, `carrier`, `curator`, `update_date`, `contact_person`, `user_rol`, `advance`, `show_codes`) VALUES
(184, 'wulf.ok@gmail.com', '9a83ab0d60fed7c37d928ccb30d1b6ae', '*********Адмінка*********', 'Parser', '+38(097) 030 03 61', 10337, NULL, 1, 'administrator', 'Магазин', 'фффф', 0, 13, NULL, '9', '2015-12-10 16:28:43', 'ПП', '9908', '10318', 'Нова Пошта', '1', 1478511632, 'aaa', 1, 1, 1);

-- --------------------------------------------------------

--
-- Структура таблиці `visualization`
--
...
--
-- Дамп даних таблиці `visualization`
--

INSERT INTO `visualization` (`id`, `text`) VALUES
(1, '<p>\r\n	Ми найкрутіший магазин в Україні!!!</p>\r\n');
...
--
-- Індекси таблиці `data_worked`
--
ALTER TABLE `data_worked`
  ADD PRIMARY KEY (`id`);

--
-- Індекси таблиці `declarations`
--
ALTER TABLE `declarations`
  ADD PRIMARY KEY (`id`);

--
-- Індекси таблиці `exchange_rates`
--
...
--
-- Індекси таблиці `numbers_add`
--
ALTER TABLE `numbers_add`
  ADD PRIMARY KEY (`id`);
...
--
-- Індекси таблиці `results_add`
--
ALTER TABLE `results_add`
  ADD PRIMARY KEY (`id`);
...
--
-- Індекси таблиці `sites_access_control`
--
ALTER TABLE `sites_access_control`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблиці `calendar`
--
ALTER TABLE `calendar`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `city`
  MODIFY `city_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15789521;
--
-- AUTO_INCREMENT для таблиці `coefficients`
--
ALTER TABLE `coefficients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `country`
  MODIFY `country_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7716094;
--
-- AUTO_INCREMENT для таблиці `data_worked`
--
ALTER TABLE `data_worked`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблиці `declarations`
--
ALTER TABLE `declarations`
...
ALTER TABLE `messages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблиці `numbers_add`
--
ALTER TABLE `numbers_add`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `payments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблиці `prepayment`
--
ALTER TABLE `prepayment`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `region`
  MODIFY `region_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15789406;
--
...
ALTER TABLE `results`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблиці `results_add`
--
ALTER TABLE `results_add`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблиці `sites_access_control`
--
ALTER TABLE `sites_access_control`
...
--
-- AUTO_INCREMENT для таблиці `visualization`
--
ALTER TABLE `visualization`
