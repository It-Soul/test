...
class Region extends CActiveRecord
{
	...
	{
		$query = self::model()->findAllByAttributes(array('country_id' => $country_id));
		$result = CHtml::listData($query,'region_id', 'name');
	...
	public function getUserRegion($region_id)
	{
		$result = self::model()->findByPk($region_id);
//		$result = CHtml::listData($query,'region_id', 'name');
