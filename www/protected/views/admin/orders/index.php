...
<div class="span2">
    <div class="well" style="max-width: 340px; padding: 8px 0;">
        <?php echo TbHtml::navList(array(
            array('label' => 'Замовлення <span class="red">' . count(Orders::model()->findAllByAttributes(array('ordered' => 0, 'completion' => 0))) . '</span>', 'url' => '/admin/orders', 'active' => true),
...
<div class="span10">
    ...
    foreach ($model as $results => $value) {
        foreach ($value as $keys => $key) {
            ...
            echo date('d.m.Y', strtotime($results)) . '<span style="font-size:18px; font-weight: bold; margin-left:15px"><a href="/admin/users/update?id=' . $user->id . '">' . $user->organisation . '&nbsp;&nbsp;&nbsp;' . $user->organisation_status . '</a></span><span class="pull-right" style="color:red; font-size: 18px; font-weight: bold">
            Заборгованість ' . Orders::model()->getUserArrears($user->id) . '</span>';
            $this->widget('yiiwheels.widgets.grid.WhGridView', array(
                ...
                'rowCssClassExpression' => '$data->ordered==0?$this->rowCssClass[1]:(($data->quantity!=$data->received && $data->send==1)?$this->rowCssClass[2]:$this->rowCssClass[0])',
                'selectableRows' => 50,
                    ...
                    array(
                        ...
                        'value' => function ($data) {
                            switch ($data->provider) {
                                ...
                                default :
                                    return $data->is_advance ? '<span style="font-style: italic; font-weight: bold">'.$data->provider.'</span>' : $data->provider;
                                    break;
                            }
                        },
...
//                        'class' => 'yiiwheels.widgets.editable.WhEditableColumn',
                    ...
                    array(
                        ...
                        'sortable' => true,
                        'type' => 'raw',
                        'footer' => Orders::model()->getUserSumByDate($keys, $results)['price_in_sum'],
                        'footerHtmlOptions' => array('style' => 'background-color:#FFFF00'),
                        'htmlOptions' => array('style' => 'width:80px;'),
                        'value' => function ($data) {
                    ...
                    array(
                        ...
                        'sortable' => true,
                        'type' => 'raw',
                        'footer' => Orders::model()->getUserSumByDate($keys, $results)['manager'],
                        'footerHtmlOptions' => array('style' => 'background-color:#FFFF00'),
                        'htmlOptions' => array('style' => 'width:80px;'),
                        'value' => function ($data) {
                    ...
                    array(
                        ...
                        'sortable' => true,
                        'type' => 'raw',
                        'footer' => Orders::model()->getUserSumByDate($keys, $results)['courier'],
                        'footerHtmlOptions' => array('style' => 'background-color:#FFFF00'),
                        'htmlOptions' => array('style' => 'width:80px;'),
                        'value' => function ($data) {
                    ...
                    array(
                        ...
                        'sortable' => true,
                        'type' => 'raw',
                        'footer' => Orders::model()->getUserSumByDate($keys, $results)['admin'],
                        'footerHtmlOptions' => array('style' => 'background-color:#FFFF00'),
                        'htmlOptions' => array('style' => 'width:80px;'),
                        'value' => function ($data) {
                    ...
                    array(
                        ...
                        'sortable' => true,
                        'type' => 'raw',
                        'footer' => Orders::model()->getUserSumByDate($keys, $results)['price_out_sum'],
                        'footerHtmlOptions' => array('style' => 'background-color:#FFFF00'),
                        'value' => function ($data) {
